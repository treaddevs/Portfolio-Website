window.showSimonOverlay = function (project) {
    ...
    if (project.title === 'Simon Game' && project.type === 'game') {
    ...
    youtubeLink.href = 'https://www.udemy.com/course/the-complete-web-development-bootcamp/';
    youtubeLink.target = '_blank';
    youtubeLink.rel = 'noopener noreferrer';
    youtubeLink.textContent = 'The Complete 2024 Web Development Bootcamp';

    detailsParagraph.appendChild(document.createTextNode('This JavaScript Simon Game was built based on this tutorial '));
    detailsParagraph.appendChild(youtubeLink);
    detailsParagraph.appendChild(document.createTextNode(' on Udemy.'));
    ...
    iframe.src = 'https://codepen.io/treaddevs/embed/VwoyZNN?default-tab=result'; 
    iframe.loading = 'lazy'; 
