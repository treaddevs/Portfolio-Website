window.showTicTacToeOverlay = function (project) {
    ...
    if (project.title === 'Tic-Tac-Toe Game' && project.type === 'game') {
    ...
    detailsParagraph.appendChild(document.createTextNode('This JavaScript Tic-Tac-Toe Game was built based on this tutorial '));
    ...
    iframe.src = 'https://codepen.io/treaddevs/embed/GRVyKMa?default-tab=result'; 
    iframe.loading = 'lazy'; 
