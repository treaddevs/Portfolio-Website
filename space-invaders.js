window.showSpaceInvadersOverlay = function (project) {
    ...
    if (project.title === 'Space Invaders Game' && project.type === 'game') {
    ...
    controlsDiv.appendChild(controlsHeading);
    ...
    youtubeLink.href = 'https://www.youtube.com/watch?v=s6LrpUTQQn0';
    youtubeLink.target = '_blank';
    youtubeLink.rel = 'noopener noreferrer';
    youtubeLink.textContent = 'Code Space Invaders in JavaScript!';

    detailsParagraph.appendChild(document.createTextNode('This JavaScript Space Invaders Game was built based on this tutorial '));
    ...
    iframe.title = 'Space Invaders Game';
    iframe.src = 'https://codepen.io/treaddevs/embed/zYgpYwy?default-tab=result'; 
    iframe.loading = 'lazy'; 
